...
\title{%
    ...
    \thanks{%
        ...
        {VTeX, Lithuania} (\url{https://vtex.lt}).
...
{Papers using the \LaTeX\ class \jphilart are published faster}.
The \textit{Journal of Philosophy} needs a standardized layout for all
